...
Base de Dados: yetiforceuser, _SENHA CRIADA ANTERIORMENTE_

Moeda: Brazil, Reais(R$)

Admin: Administrador, _CRIAR UMA SENHA SEGURA, SEU E-MAIL,_ dd/mm/yyyy, _SEU TIMEZONE_

### Configurações Posteriores
Encryption method: aes-256-cdc ; Encryption Key: _CRIAR UMA SENHA SEGURA_ ; Inicialization vector: _CRIAR UMA SENHA SEGURA_
